...
Half pounders are highly heterozygous at run timing SNPs
...
genind_to_genepop(run_timing_genind, "./genotype_data/runloci.txt")
test_LD("./genotype_data/runloci.txt", outputFile = "./ld/runloci_ld.txt")
